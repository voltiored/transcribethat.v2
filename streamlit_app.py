...
with col_style:
    ...
    with cc1:
        ...
        st.markdown(f'<div style="height:6px;border-radius:4px;background:{color};margin-top:-10px;margin-bottom:6px;box-shadow:0 0 8px {color}88;"></div>', unsafe_allow_html=True)
    with cc2:
        outline_color = st.color_picker("Color contorno", get_default("outline_color", "#000000"))
        st.markdown(f'<div style="height:6px;border-radius:4px;background:{outline_color};margin-top:-10px;margin-bottom:6px;box-shadow:0 0 8px {outline_color}88;"></div>', unsafe_allow_html=True)
...
with col_editor:
    ...
    if not ss.video_path:
        ...
        uploaded2 = st.file_uploader(
            "🎬  Arrastra tu vídeo aquí · MP4 · MOV · MKV · WEBM",
            type=["mp4", "mov", "mkv", "webm"],
            key="uploader2",
